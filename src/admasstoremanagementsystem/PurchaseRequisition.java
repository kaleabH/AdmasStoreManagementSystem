...
public class PurchaseRequisition extends JPanel{
    public JLabel name;
    public  JTable table;
...
dtm.fireTableDataChanged();
     ...
     try{
        ...
        stat =  conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
            rs = stat.executeQuery("select id AS Requsition_N0,item_name,requested_amount,received_amount,measurement, purchase_requested_at from purchase_requisition ORDER BY purchase_requested_at DESC");
    ...
    public PurchaseRequisition() throws SQLException{
        dtm = new DefaultTableModel();

        
        table = new JTable();
        name = new JLabel("purchase requisitions");
